...
#define DITHER1 (FLAGS>>DITHER1_SHIFT)
#define DITHER2 (FLAGS>>DITHER2_SHIFT)
    ...
    switch (dither & 3)
    {
        ...
        case 0:
            ...
            while (height > 0)
            {
                ...
                while (height < 0)
                {
                    ...
                    y1  = uv + READY(y_ptr[y_span]) + DITHER2;
                    y0  = uv + READY(*y_ptr++);
                    FIXUP(y1);
                    FIXUP(y0);
            ...
            if (height == 0)
            {
                ...
                while (height < 0)
                {
                    ...
                    uv  = READUV(*u_ptr++,*v_ptr++);
                    y1  = uv + READY(*y_ptr++);
                    y0  = uv + READY(*y_ptr++) + DITHER1 + DITHER2;
                    FIXUP(y1);
                    FIXUP(y0);
                    STORE(y1, *dst_ptr++);
                    STORE(y0, *dst_ptr++);
        ...
        case 1:
            ...
            while (height > 0)
            {
                ...
                {
                    /* Do 2 column pairs */
                    int32_t uv, uv2, y0, y1;

                    uv  = READUV(*u_ptr++,*v_ptr++);
                    uv2 = uv + DITHER1;
                    y1  = uv2 + READY(y_ptr[y_span]) + DITHER2;
                    y0  = uv2 + READY(*y_ptr++);
                    FIXUP(y1);
                    FIXUP(y0);
                    STORE(y1, dst_ptr[dst_span]);
        ...
        case 3:
            ...
            while (height > 0)
            {
                ...
                while (height < 0)
                {
                    ...
                    uv  = READUV(*u_ptr++,*v_ptr++);
                    uv2 = uv + DITHER1;
                    y1  = uv2 + READY(y_ptr[y_span]);
                    y0  = uv2 + READY(*y_ptr++) + DITHER2;
                    FIXUP(y1);
                    FIXUP(y0);
                    STORE(y1, dst_ptr[dst_span]);
                    STORE(y0, *dst_ptr++);
            ...
            if (height == 0)
            {
                ...
                while (height < 0)
                {
                    ...
                    uv  = READUV(*u_ptr++,*v_ptr++);
                    y1  = uv + READY(*y_ptr++) + DITHER1 + DITHER2;
                    y0  = uv + READY(*y_ptr++);
                    FIXUP(y1);
                    FIXUP(y0);
                    STORE(y1, *dst_ptr++);
